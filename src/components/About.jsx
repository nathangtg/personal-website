      ...
      >
        ...
        <div>
          <motion.h1
            ...
            className="font-poppins text-primary font-bold text-4xl name_underline max-sm:text-2xl sm:text-center md:text-start lg:text-start"
          >
        ...
        <div className="py-8">
          ...
          <div className="flex flex-col">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="flex gap-2 justify-center items-center flex-row text-xl text-primary pt-3 max-lg:justify-start inline-flex"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
            ...
            {/* Additional language entries go here */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="flex gap-2 justify-center items-center flex-row text-xl text-primary pt-3 max-lg:justify-start inline-flex"
        ...
        <div className="py-8">
          <div className="flex">
            ...
            <motion.h1
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="pl-2 font-poppins text-primary font-bold text-4xl name_underline max-sm:text-2xl sm:text-center md:text-start lg:text-start"
            >
              Nationality
            </motion.h1>
          </div>
